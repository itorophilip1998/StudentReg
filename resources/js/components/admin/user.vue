                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body"> 
                            ...
                            <div class="form-group row pb-1">
                                ...
                                <input id="my-input" v-model="register.status" class="form-control" placeholder="Addtional Information " type="text" name=""> 
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body data">   
                                ...
                                <div class="form-group "> 
                                    ...
                                    <label for="my-input">Student Status</label> 
                                    <textarea v-model="item.profile.status" name="" id="" readonly cols="30" rows="5" class="form-control">
